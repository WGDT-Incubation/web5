...
const SignUp = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${apiIp}verifier/signUp`, {
        method: 'POST',
        headers: {
      ...
      if (!res.ok) {
        ...
        setErrors({ email: responseData.error || 'Failed to sign up. Please try again.' });
        return;
      }
      ...
      setErrors({ email: 'An error occurred while signing up. Please try again.' });
    }
  };
